	...
	<div class="col-md-6">
        <div class="logo">
			<a href="index"><img src="${images}/logo.png" alt=""/></a>
				...
				<address>
					<strong>Adidas Ltd.</strong><br>Sapru Marg<br>
					Lucknow, 226001<br> <abbr title="Phone"> P:</abbr>
					9983414607
				</address>
				<address>
					<strong>E-Mail Us</strong><br> <a href="mailto:#">kjbanasthali821@gmail.com</a>
				</address>
